...
sentence_files = {
    ...
    "Administración y Gerencia": r"./Sentences/Administración y Gerencia/Administración y Gerencia.csv",
    "Consular": "./Sentences/Consular/Consular.csv",
    "Diplomacia Pública": r"./Sentences/iplomacia Pública/iplomacia Pública.csv",
    "Economía": r"./Sentences/Economía/Economía.csv",
    "Política": r"./Sentences/Política/Política.csv",
